...
namespace Contacts.Service.Logger
{
    public class CustomLogger : ILogger
    {
        public static bool Arquivo { get; set; } = true;
        ...
        {
            string caminhoArquivoLog = Environment.CurrentDirectory + @$"logs\LOG-{DateTime.Now:yyyy-MM-dd}.txt";
